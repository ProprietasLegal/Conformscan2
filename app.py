...
# Logo avec st.image pour meilleure compatibilité
st.image("logo_conformu.png", width=160)

st.markdown("<h1 style='text-align: center; color: #1a4bb8;'>ConformU – Analyse de conformité RGPD</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center; font-size: 18px; color: #444;'>Obtenez la conformité légale de votre entreprise sur le marché européen.</p>", unsafe_allow_html=True)
    ...
    if not url.startswith("http"):
        ...
        with st.spinner("Analyse en cours..."):
            try:
                ...
                total_score = 0
                st.markdown("### ✅ Résultats par critère")
                ...
                st.markdown(f"<div style='text-align:center;font-size:34px;color:#1a4bb8;margin-top:12px;'>{star_row}</div>", unsafe_allow_html=True)
